...
<form action="{{ url('/insert-supplier')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" id="hf-shop" name="shop" placeholder="Enter Shop Name..." class="form-control" required>
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" id="hf-bankname" name="bankname" placeholder="Enter Bank Name..." class="form-control">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="hf-branch_name" name="branchname" placeholder="Enter Branch Name..." class="form-control">
